...
#define      BD_AD5069S     (AAC | 0xB0)     // ADAM 5069S Module
...
FEXPORT LRESULT FTYPE FAODmaStart(LONG DeviceHandle,USHORT TrigSrc,
                     DWORD SampleRate,USHORT chan,LONG far * buffer,
                     ULONG count);
FEXPORT LRESULT FTYPE FAODmaExStart(LONG DeviceHandle,USHORT TrigSrc,
...
FEXPORT LRESULT FTYPE FAOCheck(LONG DeviceHandle,USHORT far * ActiveBuf,
                     ...
                     USHORT far * overrun,USHORT far * HalfReady, ULONG far * Transfered, USHORT far * Underrun );
...
////////////////// 2.0C \\\\\\\\\\\\\\\\\\\\\/
//\\\\\\\\\\\\\\\\ 2.2 ///////////////////////
FEXPORT LRESULT FTYPE WatchdogStart(LONG lDev); 
FEXPORT LRESULT FTYPE WatchdogFeed(LONG lDev);
FEXPORT LRESULT FTYPE WatchdogStop(LONG lDev);
///////////////////// V2.2 /////////////////////

//\\\\\\\\\\\\\\\\ 2.2C ///////////////////////
FEXPORT LRESULT FTYPE DioReadPortWord(LONG DeviceHandle,USHORT port,
                                      USHORT * ValidChannelMask,       // Xi'an added
                                      USHORT far * value);
FEXPORT LRESULT FTYPE DioWritePortWord(LONG DeviceHandle,USHORT port,
                                       USHORT mask,USHORT state);
FEXPORT LRESULT FTYPE DioReadPortDword(LONG DeviceHandle,USHORT port,
                                       ULONG * ValidChannelMask,       // Xi'an added
                                       ULONG far * value);
FEXPORT LRESULT FTYPE DioWritePortDword(LONG DeviceHandle,USHORT port,
                                        ULONG mask, ULONG state);                                     
FEXPORT LRESULT FTYPE DioGetCurrentDOWord(LONG DeviceHandle,USHORT port,
                                          USHORT * ValidChannelMask,       // Xi'an added
                                          USHORT far * value);
FEXPORT LRESULT FTYPE DioGetCurrentDODword(LONG DeviceHandle,USHORT port,
                                           ULONG * ValidChannelMask,
                                           ULONG far * value);
FEXPORT LRESULT FTYPE FAITerminate(LONG DeviceHandle);
FEXPORT LRESULT FTYPE FAOTerminate(LONG DeviceHandle);
...
FEXPORT LRESULT FTYPE DRV_FAODmaExStart(LONG DriverHandle,
...
///////////////////// V2.0C /////////////////////
//\\\\\\\\\\\\\\\\\\\ V2.2 //////////////////////
FEXPORT LRESULT FTYPE DRV_WatchdogStart(LONG lDev, LPT_WatchdogStart lpWatchdogStart); 
FEXPORT LRESULT FTYPE DRV_WatchdogFeed(LONG lDev);
FEXPORT LRESULT FTYPE DRV_WatchdogStop(LONG lDev);
///////////////////// V2.2 /////////////////////

//\\\\\\\\\\\\\\\\\\\ V2.2C //////////////////////
FEXPORT LRESULT FTYPE DRV_DioReadPortWord(LONG DriverHandle, 
                                          LPT_DioReadPortWord lpDioReadPortWord);
FEXPORT LRESULT FTYPE DRV_DioWritePortWord(LONG DriverHandle,
                                           LPT_DioWritePortWord lpDioWritePortWord);
FEXPORT LRESULT FTYPE DRV_DioReadPortDword(LONG DriverHandle,
                                           LPT_DioReadPortDword lpDioReadPortDword);
FEXPORT LRESULT FTYPE DRV_DioWritePortDword(LONG DriverHandle,
                                            LPT_DioWritePortDword lpDioWritePortDword);
FEXPORT LRESULT FTYPE DRV_DioGetCurrentDOWord(LONG DriverHandle,
                                              LPT_DioGetCurrentDOWord lpDioGetCurrentDOWord);
FEXPORT LRESULT FTYPE DRV_DioGetCurrentDODword(LONG DriverHandle,
                                               LPT_DioGetCurrentDODword lpDioGetCurrentDODword);
FEXPORT LRESULT FTYPE DRV_FAITerminate(LONG DriverHandle);
FEXPORT LRESULT FTYPE DRV_FAOTerminate(LONG DriverHandle);
///////////////////// V2.2C /////////////////////
