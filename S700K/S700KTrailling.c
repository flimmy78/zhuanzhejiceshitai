...
//    <0          失败
//------------------------------------------------------------------------------------------------
DWORD __stdcall S700K_MeasureTrailling_A( LPT_Device pDevice, LPT_Record pData )
{
   double   dfTicks;
   DWORD    dwTicksError;
   DWORD    dwRetCode = 0;
...
//------------------------------------------------------------------------------------------------
DWORD __stdcall S700K_MeasureTrailling_B( LPT_Device pDevice, LPT_Record pData )
{
   double   dfTicks;
   DWORD    dwTicksError;
   DWORD    dwRetCode = 0;
...
int __stdcall S700K_MeasureTrailling( LPT_Device pDevice, LPT_Record pData )
{
   ...
   if (S700K_MeasureTrailling_B (pDevice, pData) == -1)
      return -1;

   DAQ_Delay( 2000 );

   g_S700KData.Control.usStep = 12;
   if (S700K_MeasureTrailling_A (pDevice, pData) == -1)
      return -1;
